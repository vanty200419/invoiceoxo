...
(function () {
            ...
            return {
                define: function (a, b) {
                    ...
                    if (0 > y.getListenerIndex(c)) {
                        ...
                        p.fn = c;
                        p.priority = k;
                        for (var z = y.length - 1; 0 <= z; z--) if (y[z].priority <= k) return y.splice(z + 1, 0, p), {removeListener: f};
                        y.unshift(p)
                    }
                    ...
                    return function (k, p, f) {
                        ...
                        if (x) {
                            var z = x.listeners;
                            if (z.length) for (var z = z.slice(0),
                                                   C, w = 0; w < z.length; w++) {
                                if (x.errorProof) try {
                                    C = z[w].call(this, f, p, e, h)
                                } catch (n) {
                                } else C = z[w].call(this, f, p, e, h);
    ...
    (function () {
        function a(a, b, c) {
            ...
            this._output = CKEDITOR.tools.bind(b, c || {});
            var f = this;
            this.input = function () {
                function a() {
                    f._lastOutput = (new Date).getTime();
                    f._scheduledTimer = 0;
                    f._call()
                }

                if (!f._scheduledTimer || !1 !== f._reschedule()) {
                    var x = (new Date).getTime() - f._lastOutput;
                    x < f._minInterval ? f._scheduledTimer = setTimeout(a, f._minInterval - x) : a()
                }
            }
        }
        ...
        function d(x, b, c) {
            ...
            this.input = CKEDITOR.tools.override(this.input,
                function (a) {
                    return function () {
                        f._args = Array.prototype.slice.call(arguments);
                        a.call(this)
                    }
                })
        }
        ...
        var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            ...
            p = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, f = function (a, b) {
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var b, c = [], f = 0; f < a.length; f++) if (b = a[f]) /url|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
                return c.join("")
            },
            ...
            parseCssText: function (a, b, c) {
                ...
                if (!a || ";" == a) return f;
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, x) {
                    b && (c =
                        c.toLowerCase(), "font-family" == c && (x = x.replace(/\s*,\s*/g, ",")), x = CKEDITOR.tools.trim(x));
                    f[c] = x
                });
                return f
            },
            ...
            normalizeMouseButton: function (a, b) {
                ...
                for (var c = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE, 4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], f = 0; f < c.length; f++) {
                    var h = c[f];
            ...
            style: {
                parse: {
                    ...
                    _findColor: function (a) {
                        ...
                        return b = b.concat(c.filter(a.split(/\s+/),
                            function (a) {
            ...
            object: {
                ...
                entries: function (a) {
                    ...
                    if (CKEDITOR.env.ie &&
                        9 > CKEDITOR.env.version) for (h = 0; h < f.length; h++) b.call(a, f[h]) && c.push(f[h]);
                    return c
        ...
        CKEDITOR.tools.style.border = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                fromCssRule: function (a) {
                    ...
                    b = b || {};
                    var c = CKEDITOR.tools.array.reduce(["width", "style", "color"], function (c, f) {
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var g = this.$.getBoundingClientRect(), l = f.$.documentElement,
                        w = l.clientTop || d.$.clientTop || 0, n = l.clientLeft || d.$.clientLeft || 0, H = !0;
                    CKEDITOR.env.ie && (H = f.getDocumentElement().contains(this), f = f.getBody().contains(this), H = e && f || !e && H);
                    H && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || l.scrollLeft, c = d.$.scrollTop || l.scrollTop) : (c = e ? d.$ : l, b = c.scrollLeft, c = c.scrollTop), b = g.left + b - n, c = g.top + c - w)
                } else for (w = this, n = null; w && "body" != w.getName() &&
                "html" != w.getName();) {
                    b += w.$.offsetLeft - w.$.scrollLeft;
                    c += w.$.offsetTop - w.$.scrollTop;
                    w.equals(this) || (b += w.$.clientLeft || 0, c += w.$.clientTop || 0);
                    for (; n && !n.equals(w);) b -= n.$.scrollLeft, c -= n.$.scrollTop, n = n.getParent();
                    n = w;
                    w = (g = w.$.offsetParent) ? new CKEDITOR.dom.element(g) : null
                }
                a && (g = this.getWindow(), w = a.getWindow(), !g.equals(w) && g.$.frameElement && (a = (new CKEDITOR.dom.element(g.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
                ...
                function w(a, b) {
                    ...
                    f = a.getWindow();
                    f.equals(b) || (f = w(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y);
                    return c
                }
                ...
                e = a.getWindow();
                d = w(this, e);
                var q = w(a, e), I = this.$.offsetHeight;
                f = this.$.offsetWidth;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, g = c.endOffset, x, h = this.guard, m = this.type,
            ...
            x = h ? function (a, b) {
                return !1 === F(a, b) ? !1 : h(a, b)
            } : F;
            this.current ? f = this.current[l](!1, m, x) : (a ? f.type == CKEDITOR.NODE_ELEMENT &&
                (f = 0 < g ? f.getChild(g - 1) : !1 === x(f, !0) ? null : f.getPreviousSourceNode(!0, m, x)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === x(d, !0) ? null : d.getNextSourceNode(!0, m, x)))), f && !1 === x(f) && (f = null));
            for (; f && !this._.end;) {
                this.current = f;
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                    p(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && f(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            function h() {
                ...
                b < J - 1 || b < v - 1 || c ? (c ? a.moveToPosition(G,
            ...
            var m = a.startContainer, G = a.endContainer,
                L = a.startOffset, A = a.endOffset, M, r, F, E, u, Q;
            if (k && G.type == CKEDITOR.NODE_TEXT && (m.equals(G) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(G))) c.append(a.document.createText(G.substring(L, A))); else {
                ...
                m.type == CKEDITOR.NODE_TEXT ? k ? u = !0 : m.split(L) : 0 < m.getChildCount() ? 0 === L ? (m = m.getChild(L), M = !0) : m = m.getChild(L - 1) : F = M = !0;
                for (var S = m.getParents(), t = G.getParents(), O = n(),
                         J = S.length - 1, v = t.length - 1, B = c, D, da, aa, fa = -1, U = O; U <= J; U++) {
                    da = S[U];
                    aa = da.getNext();
                    for (U != J || da.equals(t[U]) && J < v ? b && (D = B.append(da.clone(0, e))) : M ? g(da, B, !1, F) : u && B.append(a.document.createText(da.substring(L))); aa;) {
                        if (aa.equals(t[U])) {
                            fa = U;
                            break
                        }
                ...
                B = c;
                for (U = O; U <= v; U++) if (c = t[U], aa = c.getPrevious(), c.equals(S[U])) b && (B = B.getChild(0)); else {
                    U != v || c.equals(S[U]) && v < J ? b && (D = B.append(c.clone(0, e))) : r ? g(c, B, !1, E) : Q && B.append(a.document.createText(c.substring(0, A)));
                    ...
                    switch (a) {
                        ...
                        case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                            ...
                            if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                                k = this.clone();
                                k = new CKEDITOR.dom.walker(k);
                                var J = CKEDITOR.dom.walker.whitespaces(), v = CKEDITOR.dom.walker.bookmark();
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    l = w.startPath();
                    var n = w.endPath(), H = !w.collapsed && c(w, l.block), q = !w.collapsed && c(w, n.block, 1);
                    w.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    H && w.setStartAt(l.block, CKEDITOR.POSITION_BEFORE_END);
                    q && w.setEndAt(n.block, CKEDITOR.POSITION_AFTER_START);
                    l = w.endContainer.hasAscendant("pre", !0) || w.startContainer.hasAscendant("pre", !0);
                    ...
                    (n = new CKEDITOR.dom.elementPath(n.endContainer, n.root), this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0))), this._.lastNode && w.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = w.document.createText(""), this._.lastNode.insertAfter(l)), w = null);
                    this._.started = 1;
                    l = w
                }
                n = this._.nextNode;
                ...
                for (this._.nextNode = null; n;) {
                    ...
                    n = this._getNextSourceNode(n, K, w);
                    if ((y = !n) || H && l) break
                }
                if (!d) {
                ...
                C && (z = d.getLast()) && z.type == CKEDITOR.NODE_ELEMENT && "br" == z.getName() && (!CKEDITOR.env.needsBrFiller || z.getPrevious(e) || z.getNext(e)) && z.remove();
                this._.nextNode || (this._.nextNode = y || d.equals(w) || !w ? null : this._getNextSourceNode(d, 1, w));
                return d
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                ...
                for (r in Q) {
                    m[r] = l(m[r], v) || null;
                    var E = m, t = S[r], n = l(m[S[r]], v), h = m[r], u = [], B = !0, O = void 0;
                    n ? B = !1 : n = {};
                    for (O in h) "!" == O.charAt(0) && (O = O.slice(1), u.push(O), n[O] = !0, B = !1);
                    for (; O = u.pop();) h[O] =
                        h["!" + O], delete h["!" + O];
                    E[t] = (B ? !1 : n) || null
                }
        ...
        function f(a) {
            var b, c, d, e, f = {}, g = 1;
            for (a = E(a); b = a.match(t);) (c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + g++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
        ...
        function z(a, b, e, f) {
            ...
            if (f.doFilter) {
                a:{
                    ...
                    if (a || r) {
                        y(b);
                        if (t) for (u = 0, F = t.length; u < F; ++u) if (!1 === c(t[u], b, l)) {
                            a = null;
                            break a
                        }
                        if (E) for (u = 0, F = E.length; u < F; ++u) c(E[u], b, l);
                        if (a) for (u = 0, F = a.length; u < F; ++u) d(a[u], b, l, h);
                        if (r) for (u = 0, F = r.length; u < F; ++u) d(r[u], b, l, h);
                        a = l
                    } else a = null
                }
                ...
                if (!a.allAttributes) for (k in t) F[k] || (Q.test(k) ? k == (A = k.replace(/^data-cke-saved-/, "")) || F[A] || (delete t[k], u = !0) : (delete t[k], u = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (k in B) a.allStyles || O[k] ? L.push(k + ":" + B[k]) : u = !0;
            ...
            f.toHtml && (b.name = b.name.replace(v, "cke:$1"));
            return g
        }
        ...
        function K(a, b, c) {
            ...
            if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(q()) : (a.parent && c.push({
                ...
                if (e) a.name = b, a.attributes =
                    ...
                    e = a.parent;
                    for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, v, t, g = d.length; 0 < g;) m = d[--g], f && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && r.$inline[m.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b), v.insertAfter(a), c.push({
                        check: "parent-down",
                        el: v
                    })), v.add(m, 0)) : (v = null, t = r[e.name] || r.span, m.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || m.type != CKEDITOR.NODE_ELEMENT || t[m.name] || c.push({
                        check: "el-up",
                        el: m
                    }));
                    a.remove()
        ...
        function G(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, f, m, g, v;
            if (a.name != c.element) return !1;
            for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), g = a.classes.join("|"); v = c.pop();) {
                if (-1 == g.indexOf(v)) return !1
        ...
        var r = CKEDITOR.dtd, F = CKEDITOR.tools.copy, E = CKEDITOR.tools.trim, u = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], m = this.editor && this.editor.config.protectedSource, g, v = !1,
                    t = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (g = z(e, a, f, t), g & 1) v = !0; else if (g & 2) return !1
                        ...
                        a:{
                            ...
                            1 == d.children.length && (r = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, r, c, t);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var f = void 0, m = void 0, g = void 0, v = void 0, t = void 0, r = void 0;
                        c = [];
                        for (m = 0; m < b.length; ++m) g = b[m], "string" == typeof g ? (g = g.split(/\s*:\s*/), v = g[0], t = null, r = g[1]) : (v = g.check, t = g.left, r = g.right), f || (f = g, f = f.element ? f.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                ...
                if ("string" == typeof a) {
                    ...
                    v && (e.attributes.style = CKEDITOR.tools.writeCssText(e.styles))
                } else e = a.getDefinition(), v = e.styles, d = e.attributes || {}, v && !CKEDITOR.tools.isEmpty(v) ? (v = F(v), d.style = CKEDITOR.tools.writeCssText(v, !0)) : v = {}, e = {
                    name: e.element,
                    attributes: d,
                ...
                var v = CKEDITOR.tools.clone(e), t = [], r;
                if (!1 !== b && (r = this._.transformations[e.name])) {
                    for (d =
                             0; d < r.length; ++d) m(this, e, r[d]);
                    w(e)
                }
                z(this, v, t, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                0 < t.length ? c = !1 : ((b = e.attributes["class"]) && (e.attributes["class"] = e.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(e.attributes, v.attributes, !0), b && (e.attributes["class"] = b));
        ...
        B = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, f, m, g, v;
                    a.name = c.element;
                    for (f in e) if ("class" ==
                        f) for (c = a.classes.join("|"), g = e[f].split(/\s+/); v = g.pop();) -1 == c.indexOf(v) && a.classes.push(v); else a.attributes[f] = e[f];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, g, e) {
                ...
                l && (b = [b]);
                g || (g = CKEDITOR);
                var h = b.length, k = h, p = [], f = [], x = function (a) {
                    c && (l ? c.call(g, a) : c.call(g, p, f))
                };
                if (0 === k) x(!0); else {
                    var y = function (a, b) {
                        (b ? p : f).push(a);
                        0 >= --k && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), x(b))
                    }, z = function (b, c) {
                        a[b] = 1;
                        var e = d[b];
                        delete d[b];
                        ...
                        if (a[b]) y(b, !0); else {
                            ...
                            if (!(1 < e.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? f.$.onreadystatechange = function () {
                                    if ("loaded" == f.$.readyState || "complete" == f.$.readyState) f.$.onreadystatechange = null, z(b, !0)
                                } : (f.$.onload = function () {
                                    setTimeout(function () {
                                        f.$.onload = null;
                                        f.$.onerror = null;
        ...
        return function (b, c, g) {
            var e = {}, l = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], f;
                    for (f in a) {
                        var h = a[f], y = h && h.requires;
                        if (!d[f]) {
                            if (h.icons) for (var z = h.icons.split(","), C = z.length; C--;) CKEDITOR.skin.addIcon(z[C], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[C] + ".png");
            ...
            function (e, l, h) {
                function k(a) {
                    ...
                    if (0 < n.length) for (var c = 0; c < n.length; c++) {
                        ...
                        g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == q.name && (x(q, q.parent, 1), c--) : (b || (p(), b = 1), d = d.clone(), d.parent = q, q = d, n.splice(c, 1), c--)
                    }
                }

                function p() {
                    for (; H.length;) x(H.shift(), q)
                }
                ...
                function x(b, c, d) {
                    c = c || q || w;
                    var e = q;
                    void 0 === b.previous && (y(c, b) && (q = c, C.onTagOpen(h, {}), b.returnPoint = c = q), f(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (K = !1), "textarea" == b.name && (I = !1));
                ...
                var C = new CKEDITOR.htmlParser,
                    w = l instanceof CKEDITOR.htmlParser.element ? l : "string" == typeof l ? new CKEDITOR.htmlParser.element(l) : new CKEDITOR.htmlParser.fragment,
                    n = [], H = [], q = w, I = "textarea" == w.name, K = "pre" == w.name;
                    ...
                    if (a(f)) n.push(f); else {
                        ...
                        if ("br" == e) H.push(f); else {
                            for (; !(h = (g = q.name) ? CKEDITOR.dtd[g] || (q._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || q.isUnknown || h[e]);) if (q.isOptionalClose) C.onTagClose(g); else if (e in b && g in b) g = q.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), q), !f.returnPoint && (f.returnPoint = q), q = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, g)) C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !z(e, g)) !f.returnPoint && (f.returnPoint = q), q = q.parent; else if (g in CKEDITOR.dtd.$inline && n.unshift(q), q.parent) x(q, q.parent, 1); else {
                                f.isOrphan = 1;
                                break
                            }
                            k(e);
                ...
                C.onTagClose = function (a) {
                    ...
                    for (var c = [], d = [], e = q; e != w && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
                    if (e != w) {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    e = Array.prototype.slice.call(arguments, 1), l = this.rules, h = l.length, k, p, f, x;
                for (x = 0; x < h; x++) if (d && (k = c.type, p = c.name), f = l[x], !(a.nonEditable && !f.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function t(a, d) {
                return function (g) {
                    if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var v = [], m = b(g), t, E;
                        if (m) for (r(m, 1) && v.push(m); m;) e(m) && (t = c(m)) && r(t) && ((E = c(t)) && !e(E) ? v.push(t) : (f(h).insertAfter(t), t.remove())), m = m.previous;
            ...
            var E = {elements: {}}, h = "html" == d, u = CKEDITOR.tools.extend({}, m), F;
            for (F in u) "#" in I[F] || delete u[F];
            for (F in u) E.elements[F] = t(h, a.config.fillEmptyBlocks);
            E.root = t(h, !1);
                    ...
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            for (d = b.next; d && g(d);) d =
                                d.next;
                            var v = c(b);
                            !d && e(b.parent) ? l(b.parent, f(a)) : e(d) && v && !e(v) && f(a).insertBefore(d)
                        }
                    }
                }
            }(h);
        ...
        function w(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) {
                return "\x3c" + c + d + "\x3e" + C(z(e), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = n(c), c = w(c, b), c = f(c, Q), c = p(c), c = f(c, u),
    ...
    (function () {
        ...
        n = function () {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var l = E[l.getName()], k = 0, F = c.getChildren(), u = F.count(), p = -1, n = -1, Q = 0, A = e.contains(E.$list); k <
                u; ++k) e = F.getItem(k), a(e) ? (g = e.getName(), A && g in CKEDITOR.dtd.$list ? r = r.concat(b(e, d)) : (h = !!l[g], "br" != g || !e.data("cke-eol") || k && k != u - 1 || (Q = (f = k ? r[k - 1].node : F.getItem(k + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && E.$block[f.getName()]), -1 != p || h || (p = k), h || (n = k), r.push({
                    isElement: 1,
                    isLineBreak: Q,
            ...
            return function (t, u, J, v) {
                var B = t.editor, D = !1, x;
                "unfiltered_html" == u && (u = "html", D = !0);
                if (!v.checkReadOnly()) {
                    ...
                    var D = u.range, z = u.mergeCandidates, y = "html" === u.type, q, C, T, H, Z;
                    "text" == u.type &&
                    ...
                    u.endPath = H = new CKEDITOR.dom.elementPath(D.endContainer);
                    if (!D.collapsed) {
                        q = H.block || H.blockLimit;
                        var ca = D.getCommonAncestor();
                        q && !q.equals(ca) && !q.contains(ca) && D.checkEndOfBlock() && u.zombies.push(q);
                        D.deleteContents()
                    }
                    for (; (Z = e(D)) && a(Z) && Z.isBlockBoundary() && T.contains(Z);) D.moveToPosition(Z,
                        CKEDITOR.POSITION_BEFORE_END);
                    g(D, u.blockLimit, T, H);
                    C && (D.setEndBefore(C), D.collapse(), C.remove());
                    C = D.startPath();
                    if (q = C.contains(f, !1, 1)) x = D.splitElement(q), u.inlineStylesRoot = q, u.inlineStylesPeak = C.lastElement;
                    C = D.createBookmark();
                    y && (k(q), k(x));
                    ...
                    x = t.getHtml();
                    x = "" === x || x.match(w);
                    B.enterMode === CKEDITOR.ENTER_DIV && x && ((B =
                        t.getFirst()) && B.remove(), v.setStartAt(t, CKEDITOR.POSITION_AFTER_START), v.collapse(!0));
                    if (t = J) {
                        t = u.range;
                        if ("text" == u.type && u.inlineStylesRoot) {
                            v = u.inlineStylesPeak;
                            B = v.getDocument().createText("{cke-peak}");
                            for (x = u.inlineStylesRoot.getParent(); !v.equals(x);) B = B.appendTo(v.clone()), v = v.getParent();
                        ...
                        v.setHtml(J);
                        V && (v.getFirst().remove(), v.getLast().remove());
                        if ((V = t.startPath().block) && (1 != V.getChildCount() || !V.getBogus())) a:{
                            var P;
                            if (1 == v.getChildCount() && a(P = v.getFirst()) && P.is(p) && !P.hasAttribute("contenteditable")) {
                                V = P.getElementsByTag("*");
                                t = 0;
                                for (x = V.count(); t < x; t++) if (B = V.getItem(t), !B.is(n)) break a;
                    ...
                    if (t) {
                        ...
                        var ba, D = Z.getPosition(B),
                            ...
                            B = b(u.dataWrapper, u);
                        for (F(B, P); x < B.length; x++) {
                            D = B[x];
                            if (y = D.isLineBreak) y = P, q = v, H = T = void 0, D.hasBlockSibling ? y = 1 : (T = y.startContainer.getAscendant(E.$block, 1)) && T.is({
                                div: 1,
                                p: 1
                            }) ? (H = T.getPosition(q), H ==
                            CKEDITOR.POSITION_IDENTICAL || H == CKEDITOR.POSITION_CONTAINS ? y = 0 : (q = y.splitElement(T), y.moveToPosition(q, CKEDITOR.POSITION_AFTER_START), y = 1)) : y = 0;
                            if (y) J = 0 < x; else {
                                y = P.startPath();
                                !D.isBlock && l(u.editor, y.block, y.blockLimit) && (N = h(u.editor)) && (N = t.createElement(N), N.appendBogus(), P.insertNode(N), CKEDITOR.env.needsBrFiller && (R = N.getBogus()) && R.remove(), P.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END));
                                if ((y = P.startPath().block) && !y.equals(I)) {
                                    if (R = y.getBogus()) R.remove(), V.push(y);
                                    I = y
                                }
                                D.firstNotAllowed &&
                                (C = 1);
                                if (C && D.isElement) {
                                    y = P.startContainer;
                                    for (q = null; y && !E[y.getName()][D.name];) {
                                        if (y.equals(v)) {
                                            y = null;
                                            break
                                        }
                                    ...
                                    if (y) q && (K = P.splitElement(q), u.zombies.push(K), u.zombies.push(q)); else {
                                        q = v.getName();
                                        ba = !x;
                                        y = x == B.length - 1;
                                        q = d(D.node, q);
                                ...
                                if (ba) {
                                    for (; y = ba.pop();) P.insertNode(y);
                                    ba = 0
                                } else P.insertNode(D.node);
                                D.lastNotAllowed && x < B.length - 1 && ((K = z ? Z : K) && P.setEndAt(K, CKEDITOR.POSITION_AFTER_START), C = 0);
                                P.collapse()
                            }
                        }
                        1 != B.length ? R = !1 : (R = B[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable"));
                        R && (J = !0, y = B[0].node, P.setStartAt(y, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(y, CKEDITOR.POSITION_AFTER_END));
                        u.dontMoveCaret = J;
                        u.bogusNeededBlocks = V
                    }
                    R = u.range;
                    var Y;
                    ba = u.bogusNeededBlocks;
                    for (I = R.createBookmark(); N = u.zombies.pop();) N.getParent() && (K = R.clone(), K.moveToElementEditStart(N), K.removeEmptyBlocksAtEnd());
                    if (ba) for (; N = ba.pop();) CKEDITOR.env.needsBrFiller ? N.appendBogus() : N.append(R.document.createText(" "));
                    for (; N = u.mergeCandidates.pop();) N.mergeSiblings();
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                function a() {
                    y = new CKEDITOR.dom.selection(c.getSelection());
                    y.lock()
                }
                ...
                var g = c.document, h = CKEDITOR.document, k = c.editable(), r = g.getBody(),
                    m = g.getDocumentElement(), p = k.isInline(), F, y;
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || p) n ? k.attachListener(k, "beforedeactivate", a, null, null, -1) : k.attachListener(c, "selectionCheck", a, null, null, -1), k.attachListener(k, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                    ...
                    var a = y && (y.isFake || 2 > y.getRanges().length);
                    CKEDITOR.env.gecko && !p && a || (c.lockSelection(y), F = 1)
                            ...
                            m.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    if (w) {
                                        ...
                                        w.setEndPoint(0 > z.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        w.select()
                                    }
                                }
                    ...
                    if (k) this.fake(k); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !K && !a[0]._getTableElement({table: 1}).hasAttribute("data-cke-tableselection-ignored")) g.call(this, a); else {
                        if (n) {
                            ...
                            l ? (k = b.document.$.body.createTextRange(), k.moveToElementText(l.$),
                                D.setEndPoint("EndToEnd", k), D.moveEnd("character", -1)) : (v = J.getNext(m), B = J.hasAscendant("pre"), v = !(v && v.getText && v.getText().match(k)) && (B || !J.hasPrevious() || J.getPrevious().is && J.getPrevious().is("br")), B = b.document.createElement("span"), B.setHtml("\x26#65279;"), B.insertBefore(J), v && b.document.createText("﻿").insertBefore(J));
                            b.setStartBefore(J);
                            J.remove();
                            a ? (v ? (D.moveStart("character", -1), D.select(), b.document.$.selection.clear()) : D.select(), b.moveToPosition(B, CKEDITOR.POSITION_BEFORE_START), B.remove()) :
                            ...
                            for (D = 0; D < a.length; D++) {
                                if (D < a.length - 1 && (v = a[D], B = a[D + 1], k = v.clone(), k.setStart(v.endContainer, v.endOffset), k.setEnd(B.startContainer, B.startOffset), !k.collapsed && (k.shrink(CKEDITOR.NODE_ELEMENT, !0), b = k.getCommonAncestor(), k = k.getEnclosedNode(), b.isReadOnly() || k && k.isReadOnly()))) {
                                ...
                                b.collapsed &&
                                CKEDITOR.env.webkit && p(b) && (k = f(this.root), b.insertNode(k), (v = k.getNext()) && !k.getPrevious() && v.type == CKEDITOR.NODE_ELEMENT && "br" == v.getName() ? (x(this.root), b.moveToPosition(v, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(k, CKEDITOR.POSITION_AFTER_END));
    ...
    (function () {
        ...
        function b(c) {
            ...
            if (c.collapsed) e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                if (!k) {
                    var w = c.getCommonAncestor(), k = a(x, w), w = a(y, w);
                ...
                for (q.getPosition(y) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    ...
                    if (q.equals(y)) q = null, k = !0; else {
                        var u = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
                            w = u && "false" == q.getAttribute("contentEditable"), z = u &&
                            -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, u),
                            z = u && (q.getAttribute("data-nostyle") || z);
                        if (u && q.data("cke-bookmark") || q.type === CKEDITOR.NODE_COMMENT) {
                            q = q.getNextSourceNode(!0);
                            continue
                        }
                        if (w && m && CKEDITOR.dtd.$block[u]) for (var A = q, F = g(A), G = void 0, I = F.length, K = 0, A = I && new CKEDITOR.dom.range(A.getDocument()); K < I; ++K) {
                            var G = F[K], L = CKEDITOR.filter.instances[G.data("cke-filter")];
                            if (L ? L.check(this) : 1) A.selectNodeContents(G), b.call(this, A)
                        }
                        F = u ? !p[u] || z ? 0 : w && !m ? 0 : d(q, y, h, Q) : 1;
                        if (F) if (G =
                            q.getParent(), F = h, I = f, K = l, !G || !(G.getDtd() || CKEDITOR.dtd.span)[I] && !K || F.parentRule && !F.parentRule(G)) k = !0; else {
                            if (r || u && CKEDITOR.dtd.$removeEmpty[u] && (q.getPosition(y) | Q) != Q || (r = c.clone(), r.setStartBefore(q)), u = q.type, u == CKEDITOR.NODE_TEXT || w || u == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                                for (var u = q, M; (k = !u.getNext(E)) && (M = u.getParent(), p[M.getName()]) && d(M, x, h, S);) u = M;
                                r.setEndAfter(u)
                            }
                        } else k = !0;
                        q = q.getNextSourceNode(z || w)
                    }
                    if (k && r && !r.collapsed) {
                        for (var k = H(this, e), w = k.hasAttributes(), z = r.getCommonAncestor(),
                                 u = {}, F = {}, G = {}, I = {}, X, W, Y; k && z;) {
                            if (z.getName() == f) {
                                for (X in h.attributes) !I[X] && (Y = z.getAttribute(W)) && (k.getAttribute(X) == Y ? F[X] = 1 : I[X] = 1);
                                for (W in h.styles) !G[W] && (Y = z.getStyle(W)) && (k.getStyle(W) == Y ? u[W] = 1 : G[W] = 1)
                            }
                            z = z.getParent()
                        }
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                b();
                for (f = d; !f.equals(m);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : w(f, K(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) &&
                (b(), g = d.getNext())), f = g
            }
            a.moveToBookmark(c);
        ...
        function k(a) {
            ...
            for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), p(d, e)) : z.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function p(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else g ? b = y(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
                (k = c.getPrevious(u)) &&
