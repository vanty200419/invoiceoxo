...
(function (global, factory) {
  ...
  var CardWidget = /*#__PURE__*/function () {
    ...
    _proto._init = function _init(card) {
      ...
      this._parent = card;
      $__default['default'](this).find(this._settings.collapseTrigger).on('click',function () {
        _this3.toggle();
      });
      $__default['default'](this).find(this._settings.maximizeTrigger).on('click',function () {
        _this3.toggleMaximize();
      });
      $__default['default'](this).find(this._settings.removeTrigger).on('click',function () {
        _this3.remove();
      });
    } // Static
    ;
