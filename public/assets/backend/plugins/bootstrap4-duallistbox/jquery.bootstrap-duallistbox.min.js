...
!(function (n) {
    ...
    function e(i, l) {
        if (i.settings.showFilterInputs) {
            ...
            try {
                o = new RegExp(
                    a.trim(i.elements["filterInput" + l].val()),
                    "gi"
                );
            } catch (e) {
                o = new RegExp("/a^/", "gi");
    ...
    function d(e, t) {
        ...
        e.elements["select" + t].find("option").each(function (e, t) {
            var n = a(t);
            s.eq(n.data("original-index")).data(
                "_selected",
                n.prop("selected")
            );
        });
    ...
    (l.prototype = {
        init: function () {
            ...
            return (
                ...
                this.setEventMoveAllOverride(
                    this.settings.eventMoveAllOverride
                ),
        ...
        setInfoTextFiltered: function (e, t) {
            return (
                (this.settings.infoTextFiltered = e), t && m(this), this.element
            );
        },
        setInfoTextEmpty: function (e, t) {
            return (
                (this.settings.infoTextEmpty = e), t && m(this), this.element
            );
        },
        setFilterOnValues: function (e, t) {
            return (
                (this.settings.filterOnValues = e), t && m(this), this.element
            );
        },
        setSortByInputOrder: function (e, t) {
            return (
                (this.settings.sortByInputOrder = e), t && m(this), this.element
            );
        },
        setEventMoveOverride: function (e, t) {
            return (
                (this.settings.eventMoveOverride = e),
                t && m(this),
                this.element
            );
        },
