                        ...
                        <div class="col-12 mb-3">
                            <div class="card card-outline shadow-3">
                                <div class="card-header admin-cart-header">
                                    <h3 class="card-title">{{ __('all.tasks') }}</h3>
                                    <a href="{{ url('admin/tasks/create') }}" class="btn btn-xs admin-submit-btn-grad float-right"><i
                                            class="fa fa-plus"></i>{{ __('all.add_new_task') }}</a>
                                </div>
                                <div class="card-body">
                                    <div class="e-table">
                                        <div class="table-responsive table-lg">
                                            <table class="table card-table table-vcenter text-nowrap border mb-0">
                                                <thead>
                                                    <tr>
                                                        <th>{{ __('all.project') }}</th>
                                                        <th>{{ __('all.title') }}</th>
                                                        <th>{{ __('all.start_date') }}</th>
                                                        <th>{{ __('all.deadline_date') }}</th>
                                                        <th>{{ __('all.status') }}</th>
                                                    ...
                                                    @foreach ($tasks as $row)
                                                        <tr>
                                                            <td class="text-nowrap align-middle">
                                                                <span>{{ ($row->project) ? $row->project->title : '-' }}</span></td>
                                                            ...
                                                            <td class="text-nowrap align-middle">
                                                                <span>{{ dateFormat($row->deadline_date) }}</span></td>
                                                            <td class="text-nowrap align-middle">
