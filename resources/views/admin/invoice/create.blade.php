                        ...
                        <div class="col-12 mb-3">
                            <div class="card card-outline shadow-3">
                                <div class="card-header admin-cart-header">
                                    <h3 class="card-title">{{ __('all.create_new_invoice') }}</h3>
                                </div>
                                <div class="card-body">
                            @php
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('all.invoice_date') }}</label>
                                ...
                                <div class="col-sm-4 col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('all.due_date') }}</label>
                                ...
                                <div class="col-sm-4 col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('all.invoice_number') }}<span
                                                class="text-red">*</span></label>
                                        <input type="text" name="generated_invoice_number" class="form-control"
                                            id="generated_invoice_number" value="{{ generate_invoicenumber() }}" readonly
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn admin-submit-btn-grad add_item">{{ __('all.save') }}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('select[name="customer"]').on('change', function() {
                ...
                var url = "{{ url('admin/invoices/get-customer') }}" + '/' + customerId;
                $.get(url, function(data) {
                    ...
                    $('#address').html(data.customer.shipping_address1 + '<br>' + data.customer
                        ...
                        '<br>' + data.customer.shipping_address_zip);
            ...
            $(document).on("click", "#submit_invoice", function(event) {
                ...
                $.ajax({
                    ...
                    data: $('#product-form').serialize() + "&date=" + $('#invoice_date').val() + "&due_date=" + $('#due_date').val() +
                        "&generated_invoice_number=" + $('#generated_invoice_number').val(),
