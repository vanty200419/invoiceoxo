                ...
                <div class="col-12 mb-3">
                    <div class="card card-outline card-new-color1">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('all.create_new_order') }}</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('all.order_date') }}</label>
                                ...
                                <div class="col-sm-4 col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">{{ __('all.order_number') }}<span
                                                class="text-red">*</span></label>
                                        <input type="text" name="generated_order_number" class="form-control"
                                               id="generated_order_number" value="{{ generate_ordernumber() }}"
                            ...
                            <div class="row mt-4">
                                <div class="col-md">
                                    ...
                                    <div class="billed-to">
                                        <h6><span id="customer_name">{{$customer->display_name}}</span></h6>
                                        <p><span id="address">{{ $customer->shipping_address1 }} <br/> {{ $customer->shipping_address_city }} <br/> {{ $customer->shipping_address_state }}<br/> {{$customer->shipping_address_zip }}
                                            </span><br/>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary add_item">{{ __('all.save') }}</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#submit_invoice", function (event) {
                ...
                if ($('#customer').val() == '') {
                    ...
                    swal("Error!", "Please choose customer to make invoice.", "error");
                    return false;
                }
                if ($('#order_date').val() == '') {
                ...
                if ($('#sub_total').val() == 0) {
                    ...
                    swal("Error!", "Please choose Product to make invoice.", "error");
                    return false;
                }
                $(this).hide();
                $.ajax({
                    url: "{{ url('customer/orders/create') }}",
                    method: "POST",
