...
<head>
    ...
    <title>{{__('all.admin_login')}}</title>
    @php
...
<div class="login-box">
    <div class="card card-outline admin-new-card">
        ...
        @if($updateFile)
        <div class="alert alert-dark bg-dark text-white border-0 fade show" role="alert">

                    <strong> {{__('all.update_msg') }} </strong>
                    <br>
                    <br>
                    <a href="{{ url('install/update') }}">
                        <button class="btn btn-primary btn-sm">{{__('all.update')}}</button>
                    </a>
        </div>
        @else
        <a href="#" class="h1"><b>{{__('all.login')}}</b></a>
    </div>
    <div class="card-body">
        ...
        <form method="post" action="{{route('admin-login')}}"  id="MyFormMaster">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <button type="submit" class="btn admin-btn-grad btn-block">{{__('all.login')}}</button>
                </div>
            </div>
        </form>
    </div>
