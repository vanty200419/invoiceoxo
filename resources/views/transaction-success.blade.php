...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="{{ isset($site['favicon']) && !empty($site['favicon']) && File::exists('uploads/favicon/' . $site['favicon']) ? asset('uploads/favicon/' . $site['favicon']) : asset('uploads/favicon/favicon.png') }}" />
            ...
            <div class="row no-gutters height-self-center">
                <div class="col-sm-12 text-center align-self-center">
                    <div class="iq-error position-relative">
                        <h2 class="mb-0">{{ __('all.success_msg') }}.</h2>
